    ...
    return (
      <div className="flex-1">
        <div className="flex items-center flex-col gap-2 ">
          <h1 className="text-2xl leading-tight bg-orange-500 mt-52 rounded p-5"><Loading /></h1>
        </div>
      </div>
    )
  }
      ...
      <div className="p-8 max-w-[1100px] mx-auto">
        <div className="flex items-start gap-16">
          ...
          <div className="flex flex-col gap-4">
            <a href="https://discord.gg/jjyMXf9C" className="p-4 text-sm bg-green-500 flex items-center rounded font-bold uppercase gap-2 justify-center hover:bg-green-700 transition-colors">
              <DiscordLogo size={24} />
